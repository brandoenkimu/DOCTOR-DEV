...
<head>
    ...
    <title>Expert Doctors - ClinicCare</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto text-center">
                    <h1 class="hero-title">Expert Doctors</h1>
                    <p class="lead">Access to qualified specialists across various medical fields.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="content-card">
                        <h2 class="mb-4">Our Distinguished Team</h2>
                        <p>At ClinicCare, we bring together some of the most experienced and dedicated medical professionals. Our doctors are board-certified, highly trained, and committed to providing the highest standard of care.</p>
                        
                        <h4 class="mt-4 mb-3">Specialties We Cover</h4>
                        <div class="mb-4">
                            <span class="specialty-badge">Cardiology</span>
                            <span class="specialty-badge">Dermatology</span>
                            ...
                            <span class="specialty-badge">Ophthalmology</span>
                            <span class="specialty-badge">Gynecology</span>
                            <span class="specialty-badge">Dentistry</span>
                        </div>
                        
                        <p>Each doctor brings years of experience and a patient-first approach. Whether you need a routine check-up or specialized treatment, you can trust our experts to guide you.</p>
                        
                        <div class="text-center mt-4">
                            <a href="book_appointment.py" class="btn btn-primary-custom btn-lg">Find Your Doctor</a>
                        </div>
                    </div>
                </div>
            </div>
