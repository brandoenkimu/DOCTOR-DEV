...
<head>
    ...
    <title>Secure & Private - ClinicCare</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto text-center">
                    <h1 class="hero-title">Secure & Private</h1>
                    <p class="lead">Your health data is encrypted and protected with enterprise-grade security.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="content-card">
                        <h2 class="mb-4">Your Privacy Matters</h2>
                        <p>We take your privacy seriously. ClinicCare employs state-of-the-art security measures to ensure your personal and medical information remains confidential and safe.</p>
                        
                        <div class="mt-5">
                            <div class="security-feature">
                                <i class="fas fa-lock fa-2x text-primary me-3"></i>
                                <h5 class="d-inline-block">End-to-End Encryption</h5>
                                <p class="mt-2">All data transmitted between your device and our servers is encrypted using industry-standard TLS/SSL protocols.</p>
                            </div>
                            <div class="security-feature">
                                <i class="fas fa-user-shield fa-2x text-primary me-3"></i>
                                <h5 class="d-inline-block">Access Control</h5>
                                <p class="mt-2">Only you and authorized healthcare providers can view your medical records. Every access is logged and audited.</p>
                            </div>
                            <div class="security-feature">
                                <i class="fas fa-database fa-2x text-primary me-3"></i>
                                <h5 class="d-inline-block">Secure Storage</h5>
                                <p class="mt-2">Your data is stored in secure, HIPAA-compliant data centers with redundant backups and 24/7 monitoring.</p>
                            </div>
                            <div class="security-feature">
                                <i class="fas fa-shield-alt fa-2x text-primary me-3"></i>
                                <h5 class="d-inline-block">Regulatory Compliance</h5>
                                <p class="mt-2">We adhere to strict privacy regulations and best practices to protect your health information.</p>
                            </div>
                        </div>
                        
                        <div class="text-center mt-4">
                            <a href="privacy_policy.py" class="btn btn-outline-primary btn-lg">Read Our Privacy Policy</a>
                        </div>
                    </div>
                </div>
            </div>
